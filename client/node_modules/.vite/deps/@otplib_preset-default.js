...
} from "./chunk-MKHF4Y7X.js";
import "./chunk-GAJQDMDY.js";
import {
  __commonJS,
  import_buffer,
  init_shim
} from "./chunk-K5O7R3FB.js";
...
var require_plugin_crypto = __commonJS({
  "node_modules/@otplib/plugin-crypto/index.js"(exports) {
    ...
    var crypto = _interopDefault(require_crypto_browserify());
    var createDigest = (algorithm, hmacKey, counter) => {
      const hmac = crypto.createHmac(algorithm, import_buffer.Buffer.from(hmacKey, "hex"));
      const digest = hmac.update(import_buffer.Buffer.from(counter, "hex")).digest();
...
var require_thirty_two = __commonJS({
  "node_modules/thirty-two/lib/thirty-two/thirty-two.js"(exports) {
    ...
    exports.encode = function(plain) {
      if (!import_buffer.Buffer.isBuffer(plain)) {
        plain = new import_buffer.Buffer(plain);
      }
      var i = 0;
      var j = 0;
      var shiftIndex = 0;
      var digit = 0;
      var encoded = new import_buffer.Buffer(quintetCount(plain) * 8);
    ...
    exports.decode = function(encoded) {
      ...
      if (!import_buffer.Buffer.isBuffer(encoded)) {
        encoded = new import_buffer.Buffer(encoded);
      }
      var decoded = new import_buffer.Buffer(Math.ceil(encoded.length * 5 / 8));
...
var require_plugin_thirty_two = __commonJS({
  "node_modules/@otplib/plugin-thirty-two/index.js"(exports) {
    ...
    var keyEncoder = (secret, encoding) => {
      return thirtyTwo.encode(import_buffer.Buffer.from(secret, encoding).toString("ascii")).toString().replace(/=/g, "");
    };
...
var require_core = __commonJS({
  "node_modules/@otplib/core/index.js"(exports) {
    ...
    var hotpCreateHmacKey = (algorithm, secret, encoding) => {
      return import_buffer.Buffer.from(secret, encoding).toString("hex");
    };
    ...
    function hotpDigestToToken(hexDigest, digits) {
      const digest = import_buffer.Buffer.from(hexDigest, "hex");
    ...
    var totpPadSecret = (secret, encoding, minLength) => {
      ...
      const hexSecret = import_buffer.Buffer.from(secret, encoding).toString("hex");
      if (currentLength < minLength) {
        const newSecret = new Array(minLength - currentLength + 1).join(hexSecret);
        return import_buffer.Buffer.from(newSecret, "hex").slice(0, minLength).toString("hex");
      }
      return hexSecret;
    };
...
export default require_preset_default();
/**
 * @otplib/core
 *
 ...
 * @license: MIT
 **/
//# sourceMappingURL=@otplib_preset-default.js.map
